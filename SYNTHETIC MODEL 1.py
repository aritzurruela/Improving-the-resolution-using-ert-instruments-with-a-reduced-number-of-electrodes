...
inversion_72x1_slm=ert_72x1_slm.invert(quality=quality, maxCellArea=maxCellArea, robustData=robustData, lam=lam,paraDX=paraDX)
max_72x1_sch= np.max(inversion_72x1_slm)
...
max_18x4_dd= np.max(inversion_18x4_dd)
...
max_18x4_slm= np.max(inversion_18x4_slm)
...
max_conc_dd= np.max(inversion_18x1_dd)
...
max_conc_slm= np.max(inversion_18x1_slm)
...
stats=open('mitjes_martorana_sim2.txt','w')
...
stats=open('mitjes_martorana_sim_s.txt','w')
...
dd=[martorana_sim_18x4_dd,martorana_sim_18x1_dd,martorana_sim_72x1_dd]
sch=[martorana_sim_18x4_slm,martorana_sim_18x1_slm,martorana_sim_72x1_slm]
...
mean_dd=(mean_18x4_dd,mean_18x1_dd,mean_72x1_dd)

mean_sch=(mean_18x4_sch,mean_18x1_sch,mean_72x1_sch)

mean_dds=(mean_18x4_dd_s,mean_18x1_dd_s,mean_72x1_dd_s)

mean_schs=(mean_18x4_sch_s,mean_18x1_sch_s,mean_72x1_sch_s)

names=('profile 18','concatenation','profile 72')

fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.hist(martorana_sim_18x4_dd_s,alpha=0.5, label='18',bins=50)
ax.hist(martorana_sim_18x1_dd_s,alpha=0.5, label='conc',bins=50)
ax.hist(martorana_sim_72x1_dd_s,alpha=0.5, label='72',bins=50)
ax.legend(loc='upper right')
plt.savefig('histogram_dd.png')

fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.hist(martorana_sim_18x4_slm_s,alpha=0.5, label='18',bins=50)
ax.hist(martorana_sim_18x1_slm_s,alpha=0.5, label='conc',bins=50)
ax.hist(martorana_sim_72x1_slm_s,alpha=0.5, label='72',bins=50)
ax.legend(loc='upper right')
plt.savefig('histogram_sch_s.png')

fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.hist(martorana_sim_18x4_dd,alpha=0.5, label='18',bins=50)
ax.hist(martorana_sim_18x1_dd,alpha=0.5, label='conc',bins=50)
ax.hist(martorana_sim_72x1_dd,alpha=0.5, label='72',bins=50)
ax.legend(loc='upper right')
plt.savefig('histogram_dd.png')

fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.hist(martorana_sim_18x4_slm,alpha=0.5, label='18',bins=50)
ax.hist(martorana_sim_18x1_slm,alpha=0.5, label='conc',bins=50)
ax.hist(martorana_sim_72x1_slm,alpha=0.5, label='72',bins=50)
ax.legend(loc='upper right')
plt.savefig('histogram_sch.png')


fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.set_title( 'dipole distribution')
ax.boxplot(dd,showfliers=False)
plt.savefig('boxplot dipole.png')

fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.set_title( 'schlumberger distribution')
ax.boxplot(sch,showfliers=False)
...
fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.bar(names,mean_dds)
ax.set_title('dipole absolute average small')
plt.savefig('mean_dds.png')

fig,ax=plt.subplots(figsize=(20,20),dpi=300)
ax.bar(names,mean_schs)
ax.set_title('schlumberger absolute average small')
plt.savefig('mean_schs.png')
...
plt.savefig('inversion_dipolo.png')
...
ax[0,1].text(30, -12,str(round(mean_18x4_dd_s,3)),verticalalignment='bottom', horizontalalignment='right',size=20,bbox={'facecolor': 'red', 'alpha': 0.2, 'pad': 5})
ax[0,1].set(ylim=(-15,0))
ax[0,1].set(xlim=(i,j))
#ax[0,1].set_title('martorana_18x1')
#ax[0,1].set_ylabel('Depth')
ax[0,1].set_xlabel('distance(m)')
ax[1,1].text(30, -12,str(round(mean_18x1_dd_s,3)),verticalalignment='bottom', horizontalalignment='right',size=20,bbox={'facecolor': 'red', 'alpha': 0.2, 'pad': 5})
ax[1,1].set(ylim=(-15,0))
ax[1,1].set(xlim=(i,j))
#ax[1,1].set_title('martorana_72')
#ax[1,1].set_ylabel('Depth')
ax[1,1].set_xlabel('distance (m)')
ax[2,1].text(30, -12,str(round(mean_72x1_dd_s,3)),verticalalignment='bottom', horizontalalignment='right',size=20,bbox={'facecolor': 'red', 'alpha': 0.2, 'pad': 5})
...
fig, (ax) = plt.subplots(ncols=2,nrows=3,figsize=(33,25),dpi=300)
#plt.subplots_adjust(hspace=-2)
pg.show(world,fillRegion=False,ax=ax[0,0])
...
ax[2,0].set_ylabel('Depth')
ax[2,0].set_xlabel('distance (m)')
ax[0,1].text(30, -4.5,str(round(mean_18x4_sch_s,3)),verticalalignment='bottom', horizontalalignment='right',bbox={'facecolor': 'red', 'alpha': 0.2, 'pad': 5})
ax[0,1].set(ylim=(-15,0))
ax[0,1].set(xlim=(i,j))
ax[0,1].set_title('martorana_18x1')
ax[0,1].set_ylabel('Depth')
ax[0,1].set_xlabel('martorana_conc')
ax[1,1].text(30, -4.5,str(round(mean_18x1_sch_s,3)),verticalalignment='bottom', horizontalalignment='right',bbox={'facecolor': 'red', 'alpha': 0.2, 'pad': 5})
ax[1,1].set(ylim=(-15,0))
ax[1,1].set(xlim=(i,j))
ax[1,1].set_title('martorana_72')
ax[1,1].set_ylabel('Depth')
ax[1,1].set_xlabel('distance (m)')
ax[2,1].text(30, -4.5,str(round(mean_72x1_sch_s,3)),verticalalignment='bottom', horizontalalignment='right',bbox={'facecolor': 'red', 'alpha': 0.2, 'pad': 5})
ax[2,1].set(ylim=(-15,0))
ax[2,1].set(xlim=(i,j))
ax[2,1].set_ylabel('Depth')
ax[2,1].set_xlabel('distance (m)')
...
pg.show(grid,martorana_sim_72x1_dd,cMap='bwr',cMin=-1,cMax=1,ax=ax[2])
ax[0].set(ylim=(-15,0))
ax[0].set(xlim=(0,71))
ax[0].set_title('18x4_dd')
ax[0].set_ylabel('Depth')
...
plt.savefig('martorana_dipole.png')
...
pg.show(grid,martorana_sim_72x1_slm,cMap='bwr',cMin=-1,cMax=1,ax=ax[2])
ax[0].set(ylim=(-15,0))
ax[0].set(xlim=(0,71))
ax[0].set_title('18x4_dd')
ax[0].set_ylabel('Depth')
...
plt.savefig('martorana_4x4_s.png')
...
ax[1,1].set_ylabel('Depth')
ax[1,1].set_xlabel('distance (m)')
plt.savefig('martorana_vs_martorana.png')

fig, (ax) = plt.subplots(figsize=(15,5),dpi=300)
pg.show(mesh,rhomap,label='Resistivity $(\Omega$m)',ax=ax)
...
fig, (ax) = plt.subplots(figsize=(15,5),dpi=300)
pg.show(mesh,res_model,showMesh=True,label='Resistivity $(\Omega$m)',cMap='Reds',ax=ax)
#ax.set(xlim=(10,60),ylim=(-14,0))
#ax.set_title('model')
ax.set_ylabel('Depth (m)')
ax.set_xlabel('distance (m)')
